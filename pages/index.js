  ...
  return (
    <>
      ...
      <m.main
        ...
        transition={{ duration: 0.9, ease: customEase3, delay: 0.2 }}
      >
        <section className="w-full">
          <m.div
            className="absolute top-14 md:top-[unset] md:bottom-12 md:left-4 md:w-fit text-center md:text-left z-10 leading-[1] text-rg-white uppercase w-full"
            exit={{ opacity: 0 }}
